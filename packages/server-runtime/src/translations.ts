...
type TranslationKeysMap = Record<string, string>;
/** Locale code (e.g. `"en_US"`) -> {@link TranslationKeysMap}. */
type TranslationKeysByLocale = Record<string, TranslationKeysMap>;
...
export class TranslationsRegistry {
   ...
   * state so every addon can resolve them. Call once after `register()`; calling again replaces
   * the published map.
   */
