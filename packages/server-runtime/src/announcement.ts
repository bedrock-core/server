 ...
 *
 * Every cross-addon feed built on it — the i18n bundle, the feature flags, the shared shape, and
 * whatever a package above the runtime announces — is the same three moves:
